 ...
 * a {@link NotebookDetailFragment}.
 */
public class NotebookDetailActivity extends FragmentActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (savedInstanceState == null) {
			...
			arguments.putString(NotebookDetailFragment.ARG_ITEM_ID, getIntent()
					.getStringExtra(NotebookDetailFragment.ARG_ITEM_ID));
			NotebookDetailFragment fragment = new NotebookDetailFragment();
			fragment.setArguments(arguments);
			getSupportFragmentManager().beginTransaction()
					.add(R.id.notebook_detail_container, fragment).commit();
		}
	}
